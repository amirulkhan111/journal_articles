...
- [`articles/trauma-memory-beloved/`](articles/trauma-memory-beloved/) — "Trauma, Memory, and the Unspeakable in Toni Morrison's *Beloved*," drawing on Krumholz (*African American Review* 1992), Koolish (*MELUS* 2001), and Lakshmi K et al. (*Theory and Practice in Language Studies* 2025). 2,726 words of body text, `.docx` generated, citations forensically audited and corrected (see `peer_review_audit.md`). Author name is still a placeholder — fill in before submission. **Not yet submission-ready:** the plagiarism-check score in `sources.md` is still pending a real checker run (see "Plagiarism ceiling" above).
- [`articles/oral-textual-authority-ramkatha/`](articles/oral-textual-authority-ramkatha/) — "The Ring on the Platter: Oral Frame and Textual Authority in the Ramkatha Tradition," drawing on A. K. Ramanujan's "Three Hundred Ramayanas" (*The Collected Essays of A. K. Ramanujan*, 1999), Indira Parthasarathy on Kamban (*Delhi Journal of Comparative Studies*, 2021–22), UNESCO's Ramlila heritage listing, and Stasik's *Oral-Written-Performed* (2020, attribution only). 2,661 words of body text, `.docx` generated. Author name is still a placeholder. **Not yet submission-ready:** plagiarism-check score pending a real checker run.
